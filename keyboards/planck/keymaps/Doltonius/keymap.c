...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    MO(_FN), KC_LALT, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTL,  MO(_FN)
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TILD,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LPRN, KC_RPRN, KC_DEL,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_LBRC, KC_RBRC, KC_UNDS, KC_PLUS,  _______,
    _______, _______, _______, _______, _______, KC_SPC, KC_SPC, TO(_VIM),    KC_MPLY,    KC_VOLD, KC_VOLU, KC_MNXT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT,   KC_DOWN, KC_UP,  KC_RIGHT, KC_RBRC, KC_QUOT,
...
[_VIM] = LAYOUT_planck_grid(
    ...
    LM(_QWERTY2, MOD_LCTL), GO_TO_END, _______, TD(TD_DD), FIND, G(KC_UP), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, G(KC_G), _______,
    MO(_VIM_SHIFT), _______, KC_BSPC, CHANGE_LINE, _______, G(KC_LEFT), G(KC_G), _______, G(KC_Z), G(KC_Y), FIND, KC_ENT,
    MO(_FN), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LGUI), LOWER, KC_SPC, KC_SPC, RAISE, LM(_QWERTY2, MOD_LGUI), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LCTL), MO(_FN) 
    ),
...
[_VIM_SHIFT] = LAYOUT_planck_grid(
    ...
    LM(_QWERTY2, MOD_LCTL), GO_TO_END, _______, C(KC_K), FIND, G(KC_DOWN), KC_LEFT, JOIN_LINE, KC_UP, KC_RIGHT, G(KC_G), _______,
    KC_TRNS, _______, KC_BSPC, DELETE_TO_END, _______, A(KC_LEFT), G(KC_G), _______, G(KC_Z), G(KC_Y), FIND, KC_ENT,
    MO(_FN), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LGUI), LOWER, KC_SPC, KC_SPC, RAISE, LM(_QWERTY2, MOD_LGUI), LM(_QWERTY2, MOD_LALT), LM(_QWERTY2, MOD_LCTL), MO(_FN) 
    ),
